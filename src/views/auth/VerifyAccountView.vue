<template>
  <AuthLayout :back-to="{ name: 'login' }" back-label="Voltar para o login">
    ...
    <form v-if="pendencia?.requestId" class="auth-form" novalidate @submit.prevent="confirmarCodigo">
      <BaseInput
        :model-value="code"
      ...
      <p class="auth-code-hint">O código expira após alguns minutos e só pode ser usado uma vez.</p>
