...
<style scoped>
.profile-page{width:min(100%,1080px);margin:0 auto;color:var(--student-text)}.profile-page__eyebrow,.profile-card__kicker{display:none}.profile-page__header{display:flex;align-items:flex-end;justify-content:space-between;gap:20px;margin-bottom:18px}.profile-page__header h1{margin:0;font-size:30px}.profile-page__header p{margin:6px 0 0;color:var(--student-muted);font-size:13px}.profile-page__status{min-height:34px;display:flex;align-items:center;gap:6px;padding:0 9px;border:1px solid #ead7b0;border-radius:7px;background:#fff7e8;color:#835f20;font-size:9px;font-weight:700}.profile-page__status.is-verified{border-color:#cadcc1;background:#edf5e9;color:#547341}.profile-page__grid{display:grid;grid-template-columns:minmax(0,1.55fr) minmax(270px,.8fr);gap:14px}.profile-card{padding:18px;border:1px solid var(--student-border);border-radius:10px;background:#fff}.profile-card--identity,.profile-card--form{grid-column:1}.profile-card--security,.profile-card--summary{grid-column:2}.profile-card__head{display:flex;align-items:center;justify-content:space-between;gap:12px;margin-bottom:15px}.profile-card__head h2{margin:0;font-size:16px}.profile-avatar-editor{display:grid;grid-template-columns:82px minmax(0,1fr);gap:16px;align-items:center}.profile-avatar-editor__preview{position:relative;width:82px;height:82px;display:grid;place-items:center;border-radius:50%;overflow:hidden;background:#e9e1d7;color:#6d4d1f;font-size:20px;font-weight:700}.profile-avatar-editor__preview img{width:100%;height:100%;object-fit:cover}.profile-avatar-editor__camera{position:absolute;right:0;bottom:0;width:28px;height:28px;display:grid;place-items:center;border:2px solid #fff;border-radius:50%;background:#2a211b;color:#fff}.profile-avatar-editor__content>strong{display:block;font-size:13px}.profile-avatar-editor__content>span{display:block;margin-top:3px;color:var(--student-muted);font-size:10px}.profile-avatar-editor__content>p{margin:8px 0 0;color:var(--student-muted);font-size:8px}.profile-avatar-editor__actions{display:flex;gap:8px;margin-top:9px}.profile-avatar-editor__input{display:none}.profile-link-btn{display:flex;align-items:center;gap:5px;padding:0;border:0;background:transparent;color:#76501a;font-size:9px;font-weight:700}.profile-link-btn--danger{color:#9a4945}.profile-security-list{display:grid}.profile-security-item{display:grid;grid-template-columns:32px minmax(0,1fr) auto;align-items:center;gap:9px;padding:10px 0;border-bottom:1px solid var(--student-border)}.profile-security-item:last-child{border-bottom:0}.profile-security-item__icon{width:30px;height:30px;display:grid;place-items:center;border-radius:7px;background:#f2eee8;color:#72582f}.profile-security-item strong{display:block;font-size:10px}.profile-security-item div>span{display:block;margin-top:2px;color:var(--student-muted);font-size:8px;line-height:1.3}.profile-security-item__state{padding:3px 5px;border-radius:4px;background:#f2f0ed;color:#716960;font-size:7px;font-weight:800;text-transform:uppercase}.profile-security-item__state.is-positive{background:#edf5e9;color:#547341}.profile-security-note{display:flex;align-items:flex-start;gap:7px;margin-top:12px;padding:9px;border-radius:7px;background:#f7f4f0;color:#6d645c}.profile-security-note p{margin:0;font-size:8px;line-height:1.5}.profile-form{display:grid;grid-template-columns:1fr 1fr;gap:13px}.profile-form__field--wide{grid-column:1/-1}.profile-form__field label{display:block;margin-bottom:5px;color:#59524b;font-size:9px;font-weight:700}.profile-form__control{height:40px;display:flex;align-items:center;gap:8px;padding:0 10px;border:1px solid var(--student-border);border-radius:7px;background:#fff;color:#918880}.profile-form__control:focus-within{border-color:#c9a466;box-shadow:0 0 0 3px rgba(184,121,31,.07)}.profile-form__control.has-error{border-color:#d58b87}.profile-form__control--readonly{background:#f7f5f2}.profile-form__control input{min-width:0;width:100%;border:0;outline:0;background:transparent;color:var(--student-text);font-size:10px}.profile-form__control input[readonly]{color:#7d756e}.profile-form__hint{display:block;margin-top:4px;color:var(--student-muted);font-size:8px}.profile-field-error{margin:4px 0 0;color:var(--student-danger);font-size:8px}.profile-form__actions{grid-column:1/-1;display:flex;justify-content:flex-end;gap:7px;padding-top:4px}.profile-btn{min-height:36px;padding:0 12px;border-radius:7px;font-size:9px;font-weight:700}.profile-btn:disabled{opacity:.45}.profile-btn--secondary{border:1px solid var(--student-border-strong);background:#fff;color:var(--student-text)}.profile-btn--primary{border:0;background:#2a211b;color:#fff}.profile-unsaved{display:flex;align-items:center;gap:4px;color:#8a5d1d;font-size:8px}.profile-summary-list{margin:0}.profile-summary-list>div{display:flex;justify-content:space-between;gap:12px;padding:9px 0;border-top:1px solid var(--student-border)}.profile-summary-list>div:first-child{border-top:0}.profile-summary-list dt{color:var(--student-muted);font-size:8px}.profile-summary-list dd{margin:0;text-align:right;font-size:9px;font-weight:650}.profile-summary-callout{display:flex;align-items:flex-start;gap:7px;margin-top:12px;padding:9px;border-radius:7px;background:#f7f4f0}.profile-summary-callout>svg{display:none}.profile-summary-callout strong{font-size:9px}.profile-summary-callout p{margin:3px 0 0;color:var(--student-muted);font-size:8px;line-height:1.45}.profile-toast{position:fixed;right:24px;bottom:24px;z-index:90;display:flex;align-items:center;gap:7px;padding:10px 13px;border:1px solid #cadbcd;border-radius:8px;background:#f4faf5;color:#33583a;font-size:10px;font-weight:600}.profile-toast--error{border-color:#ebcfcc;background:#fff0ef;color:#984843}.profile-spin{animation:profile-spin .7s linear infinite}@keyframes profile-spin{to{transform:rotate(360deg)}}@media(max-width:900px){.profile-page__grid{grid-template-columns:1fr}.profile-card--identity,.profile-card--form,.profile-card--security,.profile-card--summary{grid-column:1}}@media(max-width:650px){.profile-page__header{align-items:flex-start;flex-direction:column}.profile-page__header h1{font-size:25px}.profile-page__status{width:100%;justify-content:center}.profile-avatar-editor{grid-template-columns:68px minmax(0,1fr)}.profile-avatar-editor__preview{width:68px;height:68px}.profile-form{grid-template-columns:1fr}.profile-form__field,.profile-form__field--wide{grid-column:1}.profile-form__actions{width:100%}.profile-btn{flex:1}.profile-toast{left:13px;right:13px;bottom:78px}}
</style>
