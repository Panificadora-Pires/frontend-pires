...
<style scoped>
.checkout-page{width:min(100%,1120px);margin:0 auto;color:var(--student-text)}.checkout-page__header{display:flex;align-items:flex-end;justify-content:space-between;gap:22px;margin-bottom:22px}.checkout-page__eyebrow{display:none}.checkout-page__header h1{margin:0;font-size:30px}.checkout-page__header p{margin:6px 0 0;color:var(--student-muted);font-size:13px}.checkout-page__back,.checkout-page__secondary{display:inline-flex;align-items:center;gap:6px;color:#745019;font-size:11px;font-weight:700}.checkout-page__layout{display:grid;grid-template-columns:minmax(0,1fr) 340px;gap:18px;align-items:start}.checkout-payment,.checkout-summary,.checkout-result,.checkout-empty{border:1px solid var(--student-border);border-radius:10px;background:#fff}.checkout-payment{overflow:hidden}.checkout-payment__head{display:flex;align-items:center;gap:11px;padding:17px 18px;border-bottom:1px solid var(--student-border)}.checkout-payment__step{width:28px;height:28px;display:grid;place-items:center;border-radius:50%;background:#2a211b;color:#fff;font-size:10px;font-weight:800}.checkout-payment__head h2{margin:0;font-size:16px}.checkout-payment__head p{margin:3px 0 0;color:var(--student-muted);font-size:10px}.checkout-methods{display:grid;grid-template-columns:repeat(3,1fr);gap:8px;padding:16px 18px}.checkout-methods button{min-height:64px;display:flex;align-items:center;gap:9px;padding:10px 12px;border:1px solid var(--student-border);border-radius:8px;background:#fff;color:#5e5750;text-align:left;cursor:pointer}.checkout-methods button.is-active{border-color:#c79a55;background:#fbf6ed;color:#62400f;box-shadow:inset 0 0 0 1px #c79a55}.checkout-methods button span{min-width:0}.checkout-methods strong,.checkout-methods small{display:block}.checkout-methods strong{font-size:11px}.checkout-methods small{margin-top:2px;color:var(--student-muted);font-size:8px}.checkout-payment__body{padding:0 18px 18px}.checkout-cash{display:grid;grid-template-columns:34px 1fr;gap:8px 12px;padding:16px;border:1px solid var(--student-border);border-radius:8px;background:#faf8f5}.checkout-cash h3{margin:0;font-size:13px}.checkout-cash p{margin:5px 0 0;color:var(--student-muted);font-size:10px;line-height:1.5}.checkout-cash button{grid-column:1/-1;min-height:40px;display:flex;align-items:center;justify-content:center;gap:7px;border:0;border-radius:7px;background:#2a211b;color:#fff;font-size:10px;font-weight:700}.checkout-payment__error,.checkout-payment__security{display:flex;align-items:flex-start;gap:7px;margin:0 18px 16px;padding:10px;border-radius:7px;font-size:9px;line-height:1.5}.checkout-payment__error{background:var(--student-danger-soft);color:var(--student-danger)}.checkout-payment__security{background:#f6f3ef;color:#6d645c}.checkout-payment__security p{margin:0}.checkout-summary{position:sticky;top:24px;padding:18px}.checkout-summary h2{margin:0 0 14px;font-size:16px}.checkout-summary__items{padding-bottom:13px;border-bottom:1px solid var(--student-border)}.checkout-summary__items>div,.checkout-summary__row,.checkout-summary__total{display:flex;justify-content:space-between;gap:14px}.checkout-summary__items>div+div{margin-top:9px}.checkout-summary__items span,.checkout-summary__row span{min-width:0;color:var(--student-muted);font-size:9px}.checkout-summary__items strong,.checkout-summary__row strong{flex:0 0 auto;font-size:9px}.checkout-summary__row{padding-top:10px}.checkout-summary__total{align-items:baseline;margin-top:13px;padding-top:13px;border-top:1px solid var(--student-border)}.checkout-summary__total span{font-size:11px;font-weight:700}.checkout-summary__total strong{font-size:20px}.checkout-result,.checkout-empty{min-height:390px;display:flex;flex-direction:column;align-items:center;justify-content:center;text-align:center;padding:34px}.checkout-result__icon{width:58px;height:58px;display:grid;place-items:center;margin-bottom:15px;border-radius:50%;background:#f1eee9;color:#6f655c}.checkout-result__icon--success{background:var(--student-success-soft);color:var(--student-success)}.checkout-result__icon--error{background:var(--student-danger-soft);color:var(--student-danger)}.checkout-result__icon--pix,.checkout-result__icon--cash{background:#faf2e4;color:#8a5c1c}.checkout-result h2,.checkout-empty h2{margin:0;font-size:21px}.checkout-result>p,.checkout-empty p{max-width:580px;margin:7px 0 18px;color:var(--student-muted);font-size:11px;line-height:1.55}.checkout-result__qr{width:210px;padding:10px;margin-bottom:12px;border:1px solid var(--student-border);border-radius:8px;background:#fff}.checkout-result__qr img{width:100%;display:block}.checkout-result__pix-code{width:min(100%,540px);display:flex;gap:8px;align-items:stretch}.checkout-result__pix-code code{min-width:0;flex:1;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;padding:10px;border:1px solid var(--student-border);border-radius:7px;background:#faf8f5;color:#554c44;font-size:9px;text-align:left}.checkout-result__pix-code button{flex:0 0 auto;display:flex;align-items:center;gap:5px;padding:0 11px;border:0;border-radius:7px;background:#2a211b;color:#fff;font-size:9px;font-weight:700}.checkout-result__waiting{display:flex;align-items:center;gap:6px;margin-top:12px;color:var(--student-muted);font-size:9px}.checkout-result__summary{width:min(100%,380px);display:flex;justify-content:space-between;margin-top:18px;padding:12px 0;border-top:1px solid var(--student-border);border-bottom:1px solid var(--student-border);font-size:11px}.checkout-result__actions{display:flex;gap:8px;margin-top:16px}.checkout-page__primary{min-height:38px;display:inline-flex;align-items:center;justify-content:center;gap:6px;padding:0 13px;border-radius:7px;background:#2a211b;color:#fff;font-size:10px;font-weight:700}.checkout-page__secondary{padding:0 10px}.checkout-page__spinner{animation:checkout-spin .7s linear infinite}@keyframes checkout-spin{to{transform:rotate(360deg)}}@media(max-width:900px){.checkout-page__layout{grid-template-columns:1fr}.checkout-summary{position:static;order:-1}}@media(max-width:700px){.checkout-page__header{align-items:flex-start;flex-direction:column}.checkout-page__header h1{font-size:25px}.checkout-methods{grid-template-columns:1fr}.checkout-result,.checkout-empty{min-height:330px;padding:24px 16px}.checkout-result__pix-code{flex-direction:column}.checkout-result__pix-code button{min-height:38px;justify-content:center}.checkout-result__actions{width:100%;flex-direction:column}.checkout-page__primary{width:100%}.checkout-page__secondary{justify-content:center;min-height:36px}}
</style>
