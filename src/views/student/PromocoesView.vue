...
<style scoped>
.promotions-page{width:min(100%,1240px);margin:0 auto;color:var(--student-text)}
.promotions-page__header{display:flex;justify-content:space-between;align-items:flex-end;gap:22px;margin-bottom:18px}.promotions-page__eyebrow{display:none}.promotions-page__header h1{margin:0;font-size:30px}.promotions-page__header p{margin:6px 0 0;color:var(--student-muted);font-size:13px}.promotions-page__cart{min-width:188px;height:52px;display:grid;grid-template-columns:36px 1fr 16px;align-items:center;gap:9px;padding:0 12px;border:1px solid var(--student-border);border-radius:8px;background:#fff}.promotions-page__cart-icon{position:relative;width:34px;height:34px;display:grid;place-items:center;border-radius:7px;background:#f3efe9;color:#6a4a1f}.promotions-page__cart-badge{position:absolute;top:-6px;right:-6px;min-width:17px;height:17px;display:grid;place-items:center;padding:0 4px;border-radius:999px;background:var(--student-accent);color:#fff;font-size:9px;font-weight:800}.promotions-page__cart small{display:block;color:var(--student-muted);font-size:9px}.promotions-page__cart strong{font-size:11px}
.promotions-page__summary{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));margin-bottom:14px;border:1px solid var(--student-border);border-radius:9px;background:#fff}.promotions-page__summary>div{min-height:64px;display:flex;align-items:center;gap:10px;padding:0 16px;border-right:1px solid var(--student-border)}.promotions-page__summary>div:last-child{border-right:0}.promotions-page__summary-icon{width:32px;height:32px;display:grid;place-items:center;border-radius:7px;background:#f5efe5;color:#916321}.promotions-page__summary small{display:block;color:var(--student-muted);font-size:9px}.promotions-page__summary strong{display:block;margin-top:2px;font-size:15px}
.promotions-page__toolbar{display:grid;grid-template-columns:minmax(0,1fr) 215px;gap:10px;margin-bottom:11px}.promotions-page__search,.promotions-page__sort{height:42px;display:flex;align-items:center;gap:8px;padding:0 12px;border:1px solid var(--student-border);border-radius:8px;background:#fff;color:#867e76}.promotions-page__search input,.promotions-page__sort select{min-width:0;width:100%;border:0;outline:0;background:transparent;color:var(--student-text);font-size:12px}.promotions-page__sort select{appearance:none}.promotions-page__search button{border:0;background:transparent;color:#8b837a}.promotions-page__categories{display:flex;gap:6px;margin-bottom:22px;overflow:auto;scrollbar-width:none}.promotions-page__categories::-webkit-scrollbar{display:none}.promotions-page__categories button{flex:0 0 auto;min-height:34px;padding:0 11px;border:1px solid var(--student-border);border-radius:7px;background:#fff;color:#6f675f;font-size:11px;font-weight:600}.promotions-page__categories button.is-active{border-color:#c9a466;background:var(--student-accent-soft);color:#7b5117}
.promotions-page__content-head{margin-bottom:13px}.promotions-page__content-head h2{margin:0;font-size:19px}.promotions-page__content-head p{margin:4px 0 0;color:var(--student-muted);font-size:11px}.promotions-page__grid{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:13px}.promotions-page__card-wrap{position:relative}.promotions-page__discount{position:absolute;z-index:4;left:9px;top:9px;padding:4px 6px;border-radius:5px;background:#8f5b16;color:#fff;font-size:9px;font-weight:800}.promotions-page__validity{display:flex;align-items:center;gap:5px;margin:6px 2px 0;color:var(--student-muted);font-size:9px}.promotions-page__skeleton{min-height:310px;border:1px solid var(--student-border);border-radius:10px;background:#fff;overflow:hidden}.promotions-page__skeleton div{height:190px;background:#eeeae5}.promotions-page__skeleton span{display:block;height:11px;margin:14px 12px 0;border-radius:4px;background:#eeeae5}.promotions-page__state{min-height:230px;display:flex;flex-direction:column;align-items:center;justify-content:center;text-align:center;padding:28px;border:1px solid var(--student-border);border-radius:10px;background:#fff}.promotions-page__state-icon{width:48px;height:48px;display:grid;place-items:center;margin-bottom:12px;border-radius:50%;background:#f3efe9;color:#8f672b}.promotions-page__state h2{margin:0;font-size:17px}.promotions-page__state p{margin:6px 0 14px;color:var(--student-muted);font-size:12px}.promotions-page__state button,.promotions-page__state-link{min-height:36px;display:inline-flex;align-items:center;padding:0 12px;border:1px solid var(--student-border-strong);border-radius:7px;background:#fff;color:var(--student-text);font-size:11px;font-weight:700}.promotions-page__toast{position:fixed;right:24px;bottom:24px;z-index:90;display:flex;align-items:center;gap:7px;padding:10px 13px;border:1px solid #cadbcd;border-radius:8px;background:#f4faf5;color:#33583a;font-size:11px;font-weight:600}
.promotions-toast-enter-active,.promotions-toast-leave-active{transition:opacity .15s ease}.promotions-toast-enter-from,.promotions-toast-leave-to{opacity:0}@media(max-width:1120px){.promotions-page__grid{grid-template-columns:repeat(3,minmax(0,1fr))}}@media(max-width:760px){.promotions-page__header{align-items:flex-start;flex-direction:column}.promotions-page__header h1{font-size:25px}.promotions-page__cart{width:100%;min-width:0}.promotions-page__summary{grid-template-columns:1fr}.promotions-page__summary>div{min-height:54px;border-right:0;border-bottom:1px solid var(--student-border)}.promotions-page__summary>div:last-child{border-bottom:0}.promotions-page__toolbar{grid-template-columns:1fr}.promotions-page__categories{margin-left:-18px;margin-right:-18px;padding:0 18px}.promotions-page__grid{grid-template-columns:repeat(2,minmax(0,1fr));gap:9px}.promotions-page__toast{left:13px;right:13px;bottom:78px}}
</style>
