...

  {
    ...
    children: [
      ...
      },
      {
        path: "cardapio",
        name: "cardapio",
        component: () => import("@/views/student/CardapioView.vue"),
      },
      {
        path: "promocoes",
        name: "promocoes",
        component: () => import("@/views/student/PromocoesView.vue"),
      },
      {
        path: "carrinho",
        name: "carrinho",
        component: () => import("@/views/student/CarrinhoView.vue"),
      },
      {
        path: "checkout",
        name: "checkout",
      ...
      },
      {
        path: "pedidos",
        name: "pedidos",
        component: () => import("@/views/student/PedidosView.vue"),
      },
      {
        path: "favoritos",
        name: "favoritos",
        component: () => import("@/views/student/FavoritosView.vue"),
      },
      {
        path: "notificacoes",
        name: "notificacoes",
        component: () => import("@/views/student/NotificacoesView.vue"),
      },
      {
        path: "perfil",
        name: "perfil",
...

  {
    ...
    children: [
      ...
      },
      {
        ...
        component: () => import("@/views/admin/AdminPedidoDetalhesView.vue"),
      },
      {
        path: "produtos",
        name: "admin-produtos",
      ...
      },
      {
        ...
        component: () => import("@/views/admin/AdminProdutoFormView.vue"),
      },
      {
      ...
      },
      {
        ...
        component: () => import("@/views/admin/AdminPromocoesView.vue"),
      },
      {
        path: "relatorios",
        name: "admin-relatorios",
        component: () => import("@/views/admin/AdminRelatoriosView.vue"),
      },
      {
        path: "usuarios",
        name: "admin-usuarios",
