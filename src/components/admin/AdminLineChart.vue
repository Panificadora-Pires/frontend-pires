<template>
  <div class="line-chart" :class="{ 'line-chart--empty': !temDados }">
    ...
    >
      ...
      <g
        v-for="(point, index) in pontosSvg"
    ...
    <div v-else class="line-chart__empty">
...
const pontosSvg = computed(() => {
  ...
  return props.points.map((point, index) => {
    ...
    const y =
      padding.top + usableHeight - (value / escalaMax.value) * usableHeight;
